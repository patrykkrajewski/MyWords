...
# ------------------------------Wypisanie kolekcji
            self.button = Button(pos=(77, 350), size=(250, 30), text="Moje słowka 1", bold=True, on_press=self.kolekcja_jeden, background_color='#1A4667',color='#FFFFFF')
    ...
    def kolekcja_jeden(self, app):
        ...
        self.button = Button(pos=(77, 310), size=(250, 30), text="Trub Nauki!",on_press=self.nauka, bold=True,
                            background_color='#1A4667', color='#FFFFFF')
        self.add_widget(self.button)
        # ---------------------Cofnij
        self.cofnij(self)
    def nauka(self, app):
...
# -----------------------------Tytuł
    ...
    def slownik(self, app):
        ...
        self.inside = GridLayout(cols=3, pos=(25, 110), size=(350, 40))
        self.textinput_pl = TextInput(text="PL", font_size=16, background_color='#182A38', foreground_color='#FFFFFF',halign='center', multiline=False, padding_y=(10, 10), size_hint=(0.5, 0.85))
        self.inside.add_widget(self.textinput_pl)
        self.textinput_ang = TextInput(text="ANG", font_size=16, background_color='#182A38', foreground_color='#FFFFFF', halign='center', multiline=False, padding_y=(10, 10), size_hint=(0.5, 0.85))
        self.inside.add_widget(self.textinput_ang)
        self.button = Button(text="Dodaj słowo:", background_color='#43CC37', color='#FFFFFF', on_press=self.slownik_dodaj)
